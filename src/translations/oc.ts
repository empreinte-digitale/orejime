...
export default {
	banner: {
		title: null,
		description: "Reculhissèm e tractam vòstras informacions personalas amb la tòca seguenta : {purposes}.\nPer ne saber mai, mercés de legir nòstra {privacyPolicy}.",
	...
	modal: {
		...
		description: "Aicí, podètz veire e personalizar las informacions que reculhissèm vos tocant.\nPer ne saber mai, mercés de legir nòstra {privacyPolicy}.",
		privacyPolicyLabel: "politica de confidencialitat",
		close: "Tancar",
		closeTitle: null,
	...
	purpose: {
		...
		exempt: "opt-out",
		exemptTitle: "Aquesta aplicacion es cargada per defaut (mas la podètz desactivar)",
